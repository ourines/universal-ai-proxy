/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f41508fbafdfc3a87701cb675e5a97e0)
// Runtime types generated with workerd@1.20250709.0 2025-07-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PROXY_LOAD_BALANCER_KV: KVNamespace;
		TARGET_MODEL: string;
		TARGET_PROVIDER: string;
		TARGET_BASE_URL: string;
		TARGET_MAX_TOKENS: string;
		REQUIRE_UUID: string;
		VALID_UUIDS: string;
		LOAD_BALANCER_ENABLED: string;
		LOAD_BALANCER_STRATEGY: string;
		LOAD_BALANCER_WINDOW_SIZE: string;
		LOAD_BALANCER_API_KEYS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TARGET_MODEL" | "TARGET_PROVIDER" | "TARGET_BASE_URL" | "TARGET_MAX_TOKENS" | "REQUIRE_UUID" | "VALID_UUIDS" | "LOAD_BALANCER_ENABLED" | "LOAD_BALANCER_STRATEGY" | "LOAD_BALANCER_WINDOW_SIZE" | "LOAD_BALANCER_API_KEYS">> {}
}
